/*
  # Fix voting functions with proper function replacement

  1. Functions
    - Drop existing functions first to avoid conflicts
    - Create check_student_vote_status function
    - Create get_election_results function with proper return types
